//Para usar los comando de otros archivos js en un archivo js aparte, lo exportamos al html en el que lo queramos usar, como por ejemplo Platzimath en salarios, con esto podremos usar tambien las funciones dentro de un objecto.

//Existen las "class" o clases, las cuales son un grupo de funciones que hacen tareas para una misma seccion de codigo, esto lo podremos ver mejor en la clase de "JavaScript orientado a objectos"

//console.log(PlatziMatch);

//Analisis salarial

//Arreglo de personas por pais

//Arreglo de personas, empresas, trabajos


// Estructurar el analisis
